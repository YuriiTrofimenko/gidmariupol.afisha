...
/*
 * класс динамической загрузки изображений из сети,
 * заимстован из книги Харди,
 * используется для загрузки превью на главном экране
 * и превью видео на экране детализации события-кино
*/

public class ThumbDownloader<Token> extends HandlerThread {
	public static final String TAG = "ThumbDownloader";
	...
	private Bitmap getBitmap(String url) {
		...
		try {
			byte[] bitmapBytes = new AfishaFetchr().getUrlBytes(url);
